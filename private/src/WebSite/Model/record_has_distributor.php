...
/**
 * Model to record_has_distributor
 *
 * @category  	src
...
class record_has_distributor extends Model {
	...
	public function getDistributorsByRecordId($iIdRecord, $iLimit = 1000) {
