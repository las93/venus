...
<div class="one_tier_right_bloc">
	<h1 style="border-bottom:dotted 1px gray;">Films de la semaine</h1>
	{foreach from=$movies_week['items'] key=$iKey item=$oRecord}
		{if $iKey == 0}
	...
	<div class="one_right_subbloc" style="height:20px;padding-top:5px;">
		&gt; <a href="{url 'film-de-la-semaine'}">Tous les films de la semaine</a>
	</div>
</div>