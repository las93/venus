...
<div class="double_tier_left_bloc">
	<div style="float:left;width:440px;marging-bottom:5px;">
		<h1 style="border-bottom:dotted 1px gray;">DVD et Blu-ray de {$actor->get_firstname()} {$actor->get_name()}</h1>
	</div>
...
<div class="double_tier_left_bloc" style="margin-top:10px;">
	<h2 style="border-bottom:dotted 1px gray;margin-bottom:5px;">DVD et Blu-ray de {$actor->get_firstname()} {$actor->get_name()}</h2>
