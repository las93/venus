...
<div class="double_tier_left_bloc">
	<div style="float:left;width:440px;marging-bottom:5px;">
		<h1 style="border-bottom:dotted 1px gray;">Photos de {$record->get_title()}</h1>
	</div>
...
<div class="double_tier_left_bloc" style="margin-top:10px;text-align:center;">
	...
	{if !isset($alias)}{assign var=$alias value='photo-film'}{/if}
	...
	{else}
		...
		<a href="{url alias=$alias id=$record->get_id() title=$record->title_encode base=$record->base offset=$photos['pages']}">fin</a> &gt;&gt;
	{/if}
</div>