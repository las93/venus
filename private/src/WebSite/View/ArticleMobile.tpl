{* version=2; *}
	...
	<div class="grandcadre" itemscope itemtype="http://schema.org/Movie" style="background-color:white;">
		<img src="{$app.const.IMG_PROD}/images/article_{$one_news->get_id()}.jpg" style="border:0px;" width="300" itemprop="image" alt="{$one_news->get_title()|escape}" title="{$one_news->get_title()|escape}"/><br/><br/>
		<div style="padding:5px;width:290px;">
			<h2 itemprop="name">{$one_news->get_title()}</h2>
			<b><span style="color:#AAAAAA;font-size:14px;">{$one_news->date} écrit par {$user->get_login()}</span></b><br/><br/>
			...
			<div class="fb-like" data-href="http://www.iscreenway.com{$app.server.REQUEST_URI}" data-width="150" width="150"  data-colorscheme="light" data-layout="button_count" data-action="like" data-show-faces="true" data-send="false"></div>
