...
<div class="double_tier_left_bloc">
	<div style="float:left;width:440px;marging-bottom:5px;">
		<h1 style="border-bottom:dotted 1px gray;">{$photo->get_title()}</h1>
	</div>
	...
	<div style="width:630px;float:left;">
		<img src="{$app.const.IMG_PROD}/images/photo_{$photo->get_id()}.jpg" border="0" width="605" title="{$photo->get_title() addslashes}" alt="{$photo->get_title() addslashes}"/>
	</div>
</div>