...
<html>
    ...
    <body>
    	<div id="header">
    		<a href="#menu-left"></a>
			<img src="/img/logo-iscreenway.png" style="border:0px;margin-top:6px;" onClick="window.location='/';" alt="logo iScreenway" title="logo iScreenway"/>
        ...
        <nav id="menu-left">
			<ul>
				<li><a href="{url alias='home'}">Page d'accueil</a></li>
				<li><a href="{url alias='actu'}">Actualités</a></li>
				<li><a href="{url alias='dossier'}">Dossiers</a></li>
				<li><a href="{url alias='bande-annonce'}">Bandes-annonces</a></li>
			</ul>
		</nav>
		<nav id="menu-right">
