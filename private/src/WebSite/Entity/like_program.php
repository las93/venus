...
class like_program extends Entity {
	...
	/**
	 * get id_program of like_program
	 *
	 * @access public
	 * @return int
	 */
	...
	/**
	 * set id_program of like_program
	 *
	 * @access public
	 * @param  int $id_program id_program of like_program
