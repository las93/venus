...
abstract class Business extends Mother {
	...
	public function __construct() {
		...
		if (isset($sClassName)) {
			...
			$defaultView = str_replace('\\', DIRECTORY_SEPARATOR, $sNamespaceBaseName).DIRECTORY_SEPARATOR.'View'.DIRECTORY_SEPARATOR.$sClassName.'.tpl';
			$defaultLayout = str_replace('\\', DIRECTORY_SEPARATOR, $sNamespaceBaseName).DIRECTORY_SEPARATOR.'View'.DIRECTORY_SEPARATOR.'Layout.tpl';
